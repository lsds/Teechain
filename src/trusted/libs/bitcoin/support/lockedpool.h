...
public:
     ...
     */
    LockedPool(boost::shared_ptr<LockedPageAllocator> allocator, LockingFailed_Callback lf_cb_in = 0);
    ~LockedPool();
...
private:
    ...
    boost::shared_ptr<LockedPageAllocator> allocator;
...
private:
    LockedPoolManager(boost::shared_ptr<LockedPageAllocator> allocator);
