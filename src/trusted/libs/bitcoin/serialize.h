 ...
 * shared_ptr
 */
template<typename Stream, typename T> void Serialize(Stream& os, const boost::shared_ptr<const T>& p);
template<typename Stream, typename T> void Unserialize(Stream& os, boost::shared_ptr<const T>& p);
...
Serialize(Stream& os, const boost::shared_ptr<const T>& p)
{
    Serialize(os, *p);
}

template<typename Stream, typename T>
void Unserialize(Stream& is, boost::shared_ptr<const T>& p)
{
//    p = std::make_shared<const T>(deserialize, is);
    p = boost::shared_ptr<const T>(new T(deserialize, is));
}
