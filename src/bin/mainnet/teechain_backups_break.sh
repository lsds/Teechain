...
./teechain deposits_made 1NqY7EC7Y5oZSMHos3CJxv1Z69BdkLZvWy 1 1 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 0 100 76a914c0cbe7ba8f82ef38aed886fba742942a9893497788ac -p $BOB_PORT
...
if ! tail -n 40 $ALICE_BACKUP_LOG_1 | grep -q "0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff0109030000000000001976a914fbe1328227e643d7da2f81c9f4124effac1d709488ac00000000"; then
    echo "Alice's unused deposits weren't returned from backup 1!"; exit 1;
fi
if ! tail -n 30 $ALICE_BACKUP_LOG_1 | grep -q ""; then
...
if ! tail -n 3 $ALICE_LOG | grep -q ""; then
...
if ! tail -n 40 $ALICE_LOG | grep -q ""; then
...
if ! tail -n 40 $ALICE_BACKUP_LOG_2 | grep -q "0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff0109030000000000001976a914fbe1328227e643d7da2f81c9f4124effac1d709488ac00000000"; then
    echo "Alice's unused deposits weren't returned from backup 2!"; exit 1;
fi
if ! tail -n 30 $ALICE_BACKUP_LOG_2 | grep -q ""; then
    echo "Alice's channel wasn't settled from backup 2!"; exit 1;
fi

# Bob decides to shutdown
./teechain shutdown -p $BOB_PORT
if ! tail -n 30 $BOB_LOG | grep -q ""; then
    echo "Bob's channel wasn't settled!"; exit 1;
fi

# Bob decides to shutdown from his backup
./teechain shutdown -p $BOB_BACKUP_PORT_1
if ! tail -n 30 $BOB_BACKUP_LOG_1 | grep -q ""; then
