...
CAROL_LOG=bin/mainnet/test/carol.txt
...
# Deposits made
./teechain deposits_made 1PxpP8fCsdjVrS187fP2byc5uYap3fA7j2 100 2 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 0 1 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 1 10 -p $ALICE_PORT
./teechain deposits_made 1NqY7EC7Y5oZSMHos3CJxv1Z69BdkLZvWy 1 4 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 0 1 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 1 2 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 2 4 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 3 8 -p $BOB_PORT
./teechain deposits_made 1NqY7EC7Y5oZSMHos3CJxv1Z69BdkLZvWy 1 2 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 0 10 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 1 20 -p $CAROL_PORT
...
if ! tail -n 3 $BOB_LOG | grep -q "0100000001eb0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0300000000ffffffff0108000000000000001976a914ef889322cc51ca6a1b31ef4564df90318431058988ac00000000"; then
...
./teechain return_unused_deposits -p $BOB_PORT
if ! tail -n 3 $BOB_LOG | grep -q "0100000001eb0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0200000000ffffffff0104000000000000001976a914ef889322cc51ca6a1b31ef4564df90318431058988ac00000000"; then
...
./teechain settle_channel $CHANNEL_1 -p $BOB_PORT
if ! tail -n 3 $BOB_LOG | grep -q ""; then
    echo "Failed to settle Bob's channel 1!"; exit 1;
fi
...
if ! tail -n 40 $BOB_LOG | grep -q ""; then
    echo "Failed to settle Bob's channel 1 as part of shutdown"; exit 1;
fi
if ! tail -n 40 $BOB_LOG | grep -q "0100000002eb0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffffeb0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff0116000000000000001976a914ef889322cc51ca6a1b31ef4564df90318431058988ac00000000"; then
