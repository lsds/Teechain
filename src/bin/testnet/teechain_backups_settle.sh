...
./teechain deposits_made my6NJU1T6gL5f3TfmSPN4idUytdCQHTmsU 1 1 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 0 100 -p $BOB_PORT
...
EXPECTED_RETURN_TX=0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff0109030000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000
...
if ! tail -n 4 $ALICE_LOG | grep -q ""; then
...
if ! tail -n 40 $ALICE_BACKUP_LOG_2 | grep -q ""; then
    echo "Alice's channel wasn't settled!"; exit 1;
fi
