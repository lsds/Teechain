...
./teechain setup_deposits 4 -p $ALICE_PORT
./teechain setup_deposits 2 -p $BOB_PORT

# Deposits made
./teechain deposits_made mmY6ijr6uLP3DdRFC4nwL23HSKsH2xgy74 1 4 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 0 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 1 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 2 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 3 100 -p $ALICE_PORT
./teechain deposits_made my6NJU1T6gL5f3TfmSPN4idUytdCQHTmsU 1 2 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 0 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 1 100 -p $BOB_PORT
...
# Alice add to her deposit
./teechain add_deposit $CHANNEL_1 1 -p $ALICE_PORT

# Bob check balance
./teechain balance $CHANNEL_1 -p $BOB_PORT
if ! tail -n 4 $BOB_LOG | grep -q "My balance is: 148, remote balance is: 152"; then
    echo "Bob's balance check failed after alice's send!"; exit 1;
fi
...
# Bob check balance
./teechain balance $CHANNEL_1 -p $BOB_PORT
if ! tail -n 4 $BOB_LOG | grep -q "My balance is: 148, remote balance is: 252"; then
    echo "Bob's balance check failed after alice's send!"; exit 1;
fi
...
# Bob check balance
./teechain balance $CHANNEL_1 -p $BOB_PORT
if ! tail -n 4 $BOB_LOG | grep -q "My balance is: 248, remote balance is: 252"; then
    echo "Bob's balance check failed after alice's send!"; exit 1;
fi
...
# Bob check balance
./teechain balance $CHANNEL_1 -p $BOB_PORT
if ! tail -n 4 $BOB_LOG | grep -q "My balance is: 248, remote balance is: 352"; then
    echo "Bob's balance check failed after alice's send!"; exit 1;
fi
...
# Alice remove her deposit
./teechain remove_deposit $CHANNEL_1 3 -p $ALICE_PORT
...
EXPECTED_RETURN_TX=0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0300000000ffffffff0164000000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000
...
./teechain add_deposit $CHANNEL_1 3 -p $ALICE_PORT
./teechain balance $CHANNEL_1 -p $ALICE_PORT
if ! tail -n 4 $ALICE_LOG | grep -q "My balance is: 252, remote balance is: 248"; then
...
if ! tail -n 4 $ALICE_LOG | grep -q ""; then
...
if ! tail -n 40 $ALICE_BACKUP_LOG_2 | grep -q ""; then
    echo "Alice's channel wasn't settled!"; exit 1;
fi
