...
# Deposits made
./teechain deposits_made mmY6ijr6uLP3DdRFC4nwL23HSKsH2xgy74 1 2 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 0 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 1 1000 -p $ALICE_PORT
./teechain deposits_made my6NJU1T6gL5f3TfmSPN4idUytdCQHTmsU 1 1 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 0 100 76a914c0cbe7ba8f82ef38aed886fba742942a9893497788ac -p $BOB_PORT
...
# Extract the channel id for the channel created
ALICE_BACKUP_CHANNEL_2=$(grep "Channel ID:" $ALICE_BACKUP_LOG_2 | awk '{print $3}')
...
if ! tail -n 40 $ALICE_BACKUP_LOG_1 | grep -q "0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff0109030000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000"; then
    echo "Alice's unused deposits weren't returned from backup 1!"; exit 1;
fi
if ! tail -n 30 $ALICE_BACKUP_LOG_1 | grep -q ""; then
    echo "Alice's channel wasn't settled from backup 1!"; exit 1;
fi

# Send from Alice to Bob should just block forever...
./teechain send $CHANNEL_1 1 -p $ALICE_PORT &
sleep 1

# Settle and shutdown
./teechain settle_channel $CHANNEL_1 -p $ALICE_PORT
if ! tail -n 3 $ALICE_LOG | grep -q ""; then
    echo "Alice's channel wasn't settled after send! It's blocked?"; exit 1;
fi

# Adding deposits should just block forever...
./teechain add_deposit $CHANNEL_1 0 -p $ALICE_PORT &
sleep 1
...
./teechain settle_channel $CHANNEL_1 -p $ALICE_PORT
if ! tail -n 3 $ALICE_LOG | grep -q ""; then
    echo "Alice's channel wasn't settled after deposit! It's blocked?"; exit 1;
fi

# Alice decides to get her unused deposit out
./teechain shutdown -p $ALICE_PORT
if ! tail -n 40 $ALICE_LOG | grep -q "0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff0109030000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000"; then
...
if ! tail -n 40 $ALICE_BACKUP_LOG_2 | grep -q "0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff0109030000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000"; then
    echo "Alice's unused deposits weren't returned from backup 2!"; exit 1;
fi
if ! tail -n 30 $ALICE_BACKUP_LOG_2 | grep -q ""; then
    echo "Alice's channel wasn't settled from backup 2!"; exit 1;
fi

# Bob decides to shutdown
./teechain shutdown -p $BOB_PORT
if ! tail -n 30 $BOB_LOG | grep -q ""; then
    echo "Bob's channel wasn't settled!"; exit 1;
fi

# Bob decides to shutdown from his backup
./teechain shutdown -p $BOB_BACKUP_PORT_1
if ! tail -n 30 $BOB_BACKUP_LOG_1 | grep -q ""; then
