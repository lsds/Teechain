...
./teechain setup_deposits 3 -p $ALICE_PORT
./teechain setup_deposits 3 -p $BOB_PORT

# Deposits made
./teechain deposits_made mmY6ijr6uLP3DdRFC4nwL23HSKsH2xgy74 1 3 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 0 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 1 1000 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feC 2 9 -p $ALICE_PORT
./teechain deposits_made my6NJU1T6gL5f3TfmSPN4idUytdCQHTmsU 1 3 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feD 0 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feE 2 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feF 4 100 -p $BOB_PORT
...
# Bob check balance
./teechain balance $CHANNEL_1 -p $BOB_PORT
if ! tail -n 3 $BOB_LOG | grep -q "My balance is: 248, remote balance is: 1052"; then
    echo "Bob's balance check failed after alice's send!"; exit 1;
fi

EXPECTED_SETTLE=

EXPECTED_ALICE_RETURN=0100000001ec0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0200000000ffffffff0109000000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000
...
if ! tail -n 40 $ALICE_LOG | grep -q $EXPECTED_ALICE_RETURN; then
...
if ! tail -n 40 $ALICE_BACKUP_LOG_1 | grep -q $EXPECTED_ALICE_RETURN; then
...
if ! tail -n 40 $ALICE_BACKUP_LOG_2 | grep -q $EXPECTED_ALICE_RETURN; then
...
EXPECTED_BOB_SETTLE=

EXPECTED_BOB_RETURN=0100000001ef0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0400000000ffffffff0164000000000000001976a914c0cbe7ba8f82ef38aed886fba742942a9893497788ac00000000

# Bob decides to shutdown
./teechain shutdown -p $BOB_PORT
if ! tail -n 40 $BOB_LOG | grep -q $EXPECTED_BOB_RETURN; then
    echo "Bob's unused deposits weren't returned!"; exit 1;
fi
if ! tail -n 30 $BOB_LOG | grep -q $EXPECTED_BOB_SETTLE; then
    echo "Bob's channel wasn't settled!"; exit 1;
fi

# Bob decides to shutdown from his backup
./teechain shutdown -p $BOB_BACKUP_PORT_1
if ! tail -n 40 $BOB_BACKUP_LOG_1 | grep -q $EXPECTED_BOB_RETURN; then
    echo "Bob's unused deposits weren't returned from backup 1!"; exit 1;
fi
if ! tail -n 30 $BOB_BACKUP_LOG_1 | grep -q $EXPECTED_BOB_SETTLE; then
