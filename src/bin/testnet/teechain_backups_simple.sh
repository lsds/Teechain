...
ALICE_BACKUP_LOG_1=bin/testnet/test/alice_backup_1.txt
ALICE_BACKUP_LOG_2=bin/testnet/test/alice_backup_2.txt

BOB_LOG=bin/testnet/test/bob.txt
BOB_BACKUP_LOG_1=bin/testnet/test/bob_backup_1.txt
...
# Deposits made
./teechain deposits_made mmY6ijr6uLP3DdRFC4nwL23HSKsH2xgy74 2 2 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 0 100 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feA 1 1000 -p $ALICE_PORT
./teechain deposits_made my6NJU1T6gL5f3TfmSPN4idUytdCQHTmsU 2 1 edec34c9bb3a4395cd8d1e9300725f537235d8a058fc6a7ae519003b64fd0feB 0 100 76a914c0cbe7ba8f82ef38aed886fba742942a9893497788ac -p $BOB_PORT
...
if ! tail -n 3 $ALICE_LOG | grep -q ""; then
    echo "Alice's channel wasn't settled!"; exit 1;
fi

# Alice decides to get her unused deposit out
./teechain shutdown -p $ALICE_PORT
if ! tail -n 40 $ALICE_LOG | grep -q "0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff012a020000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000"; then
    echo "Alice's unused deposits weren't returned!"; exit 1;
fi
if ! tail -n 30 $ALICE_LOG | grep -q ""; then
    echo "Alice's channel wasn't settled!"; exit 1;
fi

# Alice decides to shutdown from her backup 1
./teechain shutdown -p $ALICE_BACKUP_PORT_1
if ! tail -n 40 $ALICE_BACKUP_LOG_1 | grep -q "0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff012a020000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000"; then
    echo "Alice's unused deposits weren't returned from backup 1!"; exit 1;
fi
if ! tail -n 30 $ALICE_BACKUP_LOG_1 | grep -q ""; then
...
if ! tail -n 40 $ALICE_BACKUP_LOG_2 | grep -q "0100000001ea0ffd643b0019e57a6afc58a0d83572535f7200931e8dcd95433abbc934eced0100000000ffffffff012a020000000000001976a9144208343a1b63978713f830666ce6d5ab7fa1784488ac00000000"; then
    echo "Alice's unused deposits weren't returned from backup 2!"; exit 1;
fi
if ! tail -n 30 $ALICE_BACKUP_LOG_2 | grep -q ""; then
    echo "Alice's channel wasn't settled from backup 2!"; exit 1;
fi

# Bob decides to shutdown
./teechain shutdown -p $BOB_PORT
if ! tail -n 30 $BOB_LOG | grep -q ""; then
    echo "Bob's channel wasn't settled!"; exit 1;
fi

# Bob decides to shutdown from his backup
./teechain shutdown -p $BOB_BACKUP_PORT_1
if ! tail -n 30 $BOB_BACKUP_LOG_1 | grep -q ""; then
